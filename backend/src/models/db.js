...
const initialProblems = [
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "nums = [2,7,11,15], target = 9", expected: "[0,1]" },
      { id: 2, name: "Case 2", input: "nums = [3,2,4], target = 6", expected: "[1,2]" },
      { id: 3, name: "Case 3", input: "nums = [3,3], target = 6", expected: "[0,1]" }
    ],
  ...
  },
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "s = \"babad\"", expected: "\"bab\"" }, // Or aba
      { id: 2, name: "Case 2", input: "s = \"cbbd\"", expected: "\"bb\"" }
    ],
  ...
  },
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "word1 = \"horse\", word2 = \"ros\"", expected: "3" }
    ],
  ...
  },
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "root = [3,9,20,null,null,15,7]", expected: "[[3],[9,20],[15,7]]" }
    ],
  ...
  },
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "n = 5, edges = [[0,1],[0,2],[0,3],[1,4]]", expected: "true" }
    ],
  ...
  },
  {
    ...
    testCases: [
      { id: 1, name: "Case 1", input: "nums = [5,2,3,1]", expected: "[1,2,3,5]" }
    ],
